const RENDER_PAGES = 'RENDER-PAGES'
let inintailState = [
    {
        id: 1,
        alias: "",
        ...
        icon: "home",
        header: "Sexy-Engine",
        data: "Сайт создан при помощи технологий React, JavaScript, HTML, CSS и многих других"
    },
    {
        id: 2,
        alias: "portfolio",
        ...
        icon_type: "fas",
        icon: "briefcase",
        header: "\"Это Мами сама своими чёрными ручками сделала..\"",
        portfolio: [
            {
                id: 1,
                title: "Hotel Russ",
    ...
    },
    {
        id: 3,
        alias: "technologies",
        menu_text: "Технологии",
        sr_text: "Technologies",
        icon_type: "fas",
        icon: "cogs",
        header: "Могу, умею, практикую",
        technologies: [
            {
                id: 1,
                name: "HTML",
    ...
    },
    {
        ...
        icon_type: "fas",
        icon: "address-card",
        header: "Немного о себе любимом",
        data: "Молодой крАкодил завёл себе прекрасную, любящую жену."
    },
    {
        id: 5,
        alias: "contacts",
        ...
        icon_type: "fas",
        icon: "user-edit",
        header: "Всегда у аппарата",
        data: "Перечень контактов и форма обратной связи"
    }
]

const pageReducer = (state = inintailState, action) => {
    return state
}

export const pageReducerActionCreator = () => ({type: RENDER_PAGES})
